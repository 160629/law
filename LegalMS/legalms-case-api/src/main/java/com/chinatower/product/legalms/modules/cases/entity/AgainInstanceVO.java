...
@Table(name = "t_case_again_instance")
@Data
@ToString
@ApiModel(value="再审Table")
public class AgainInstanceVO {
    /*
     * 再审
     */

    @Id
    @Column(name = "zaishen_id")
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @ApiModelProperty(name="zaishenId",value = "再审ID",required = true)
    private String zaishenId;  //再审ID
    ...
    @ApiModelProperty(name="claimant",value = "再上诉人名称")
    private String claimant;  //再上诉人名称

    @Column(name = "claimant_lawsuit_request")
    @ApiModelProperty(name="claimantLawsuitRequest",value = "再上诉人诉讼请求")
    private String claimantLawsuitRequest; //再上诉人诉讼请求

    @Column(name = "claimant_key_evidence")
    @ApiModelProperty(name="claimantKeyEvidence",value = "再上诉人关键证据")
    private String claimantKeyEvidence;  //再上诉人关键证据
