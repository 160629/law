...
@Table(name = "t_case_second_instance")
@Data
@ToString
@ApiModel(value="二审Table")
public class SecondInstanceVO {
    /*
     * 二审
     */

    @Id
    @Column(name = "ershen_id")
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @ApiModelProperty(name="ershenId",value = "二审ID",required = true)
    private String ershenId;  //二审ID
    ...
    @ApiModelProperty(name="appellant",value = "上诉人")
    private String appellant;  //上诉人

    @Column(name = "appeal_request")
    @ApiModelProperty(name="appealRequest",value = "上诉请求")
    private String appealRequest;  //上诉请求

    @Column(name = "appellant_key_evidence")
    @ApiModelProperty(name="appellantKeyEvidence",value = "上诉人关键证据")
    private String appellantKeyEvidence; //上诉人关键证据

    @Column(name = "appellee")
    @ApiModelProperty(name="appellee",value = "被上诉人")
    private String appellee;  //被上诉人

    @Column(name = "appellee_plea_reply")
    @ApiModelProperty(name="appelleePleaReply",value = "被上诉人答辩意见")
    private String appelleePleaReply; //被上诉人答辩意见

    @Column(name = "appellee_key_evidence")
    @ApiModelProperty(name="appelleeKeyEvidence",value = "被上诉人关键证据")
    private String appelleeKeyEvidence; //被上诉人关键证据
