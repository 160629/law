...
public class DisputeConstClass {
    ...
    public static class FAILURE {
        ...
        public static final String TA_FAILURE_MESS = "审批参与者处理失败";
    ...
    /*执行单位限制*/
    public static final String ACTIVITY_EXE_UNIT_LIMIT = "110";
    /*财务单位限制*/
    public static final String ACTIVITY_FINANCE_UNIT_LIMIT = "16";
    ...
    public static final String TYPE_IS_COUNTERSIGN = "isCountersign";
    ...
    public static final String REQUEST_ERR_CASEID = "关联的案件不是在办状态的，请重新选择案件!";
    ...
    public static final String MESSAGE_VERSIONID =  "当前流程未设置版本号";
    ...
    public static final String SFFWSHRSH = "sffwshrsh";
    public static final String FWCSRSH = "fwcsrsh";
    public static final String FWSHRSH = "fwshrsh";
    ...
    // 协助执行流程常量
    // 编号类别标识
    public static final String BUSINESS_TYPE = "XZ";
    // 业务标识
    public static final String T_ISSUE_ASSIST = "t_issue_assist";
    // 接口执行结果
    public static final String TISSUE_ASSIST_TEMP_SUCCESS = "协助执行流程起草暂存成功";
    public static final String TISSUE_ASSIST_TEMP_FAILED = "协助执行流程起草暂存失败";
    public static final String TISSUE_ASSIST_SELECT_ALL_SUCCESS = "协助执行流程列表查询成功";
    public static final String TISSUE_ASSIST_SELECT_ALL_FAILED = "协助执行流程列表查询失败";
    public static final String TISSUE_ASSIST_DELETE_T_ISSUE_ASSIST_SUCCESS = "协助执行流程删除成功";
    public static final String TISSUE_ASSIST_DELETE_T_ISSUE_ASSIST_FAILED = "协助执行流程删除失败";
    public static final String TISSUE_ASSIST_UPDATE_SUCCESS = "协助执行流程更新成功";
    public static final String TISSUE_ASSIST_UPDATE_FAILED = "协助执行流程更新失败";
    public static final String TISSUE_ASSIST_SELECT_RELATIONSHIP_LIST_SUCCESS = "协助执行审批中关系列表查询成功";
    public static final String TISSUE_ASSIST_SELECT_RELATIONSHIP_LIST_FAILED = "协助执行审批中关系列表查询失败";
    public static final String TISSUE_ASSIST_SELECT_RELATIONSHIP_LIST_IN_CREATE_SUCCESS = "协助执行起草时关系列表查询成功";
    public static final String TISSUE_ASSIST_SELECT_RELATIONSHIP_LIST_IN_CREATE_FAILED = "协助执行起草时关系列表查询失败";
    public static final String TISSUE_ASSIST_UPDATE_RELATION_SUCCESS = "协助执行更新关系成功";
    public static final String TISSUE_ASSIST_UPDATE_RELATION_FAILED = "协助执行更新关系失败";
    public static final String TISSUE_ASSIST_FIND_BASE_INFO_SUCCESS = "协助执行查询基础信息成功";
    public static final String TISSUE_ASSIST_FIND_BASE_INFO_FAILED = "协助执行查询基础信息失败";
    public static final String TISSUE_ASSIST_FIND_ONE_SUCCESS = "协助执行查询详情成功";
    public static final String TISSUE_ASSIST_FIND_ONE_FAILED = "协助执行查询详情失败";
    // 错误原因
    // -1 参数列表为空
    public static final String PARAM_EMPTY = "参数列表为空";
    // -2 数据影响条数不正确
    public static final String UPDATE_NUM = "处理失败";
    // -3 方法抛出异常
    public static final String EXCEPTION = "处理异常";
}
