...
public class OrgBeanVO implements Serializable {
    ...
    private String orgParentCodeName;
    ...
    /*增加数据*/
    @ApiModelProperty(value="userName",name="userName",hidden = true)
    private String userName;
    @ApiModelProperty(value="accountId",name="accountId",hidden = true)
    private String accountId;
    @ApiModelProperty(value="companyName",name="companyName",hidden = true)
    private String companyName;
    @ApiModelProperty(value="accountStatus",name="accountStatus",hidden = true)
    private String accountStatus;

    private String orgTableType;
    ...
    @JsonProperty("orgTableType")
    public String getOrgTableType() {
        return orgTableType;
    }
    @JsonProperty("param")
    public void setOrgTableType(String orgTableType) {
        this.orgTableType = orgTableType;
    }
    ...
    public String getOrgParentCodeName() {
        return orgParentCodeName;
    }

    public void setOrgParentCodeName(String orgParentCodeName) {
        this.orgParentCodeName = orgParentCodeName;
    }
