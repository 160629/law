...
public class FileUtil extends cn.hutool.core.io.FileUtil {
	 ...
	 * 导出excel
	 */
	public static void downloadExcel(List<Map<String, Object>> list, String fileName, HttpServletResponse response)
			throws IOException {
	...
	public static void checkSize(long maxSize, long size) {
		if (size > (maxSize * 1024 * 1024)) {
			throw new MyOwnRuntimeException("文件超出规定大小");
		}
	}
	...
	public static boolean check(File file1, File file2) {
		...
		return null != img1Md5 && img1Md5.equals(img2Md5);
	}
