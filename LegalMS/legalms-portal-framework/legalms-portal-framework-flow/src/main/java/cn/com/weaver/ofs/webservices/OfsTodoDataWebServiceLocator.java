...
public class OfsTodoDataWebServiceLocator extends org.apache.axis.client.Service implements cn.com.weaver.ofs.webservices.OfsTodoDataWebService {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7576435001338868361L;
    ...
    private java.lang.String OfsTodoDataWebServiceHttpPort_address = "services/OfsTodoDataWebService";
     ...
     */
    public java.rmi.Remote getPort(Class serviceEndpointInterface,String url) throws javax.xml.rpc.ServiceException {
        try {
        	OfsTodoDataWebServiceHttpPort_address=url+OfsTodoDataWebServiceHttpPort_address;
